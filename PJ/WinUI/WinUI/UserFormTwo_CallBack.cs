...
namespace WinUI
{
    class UserFormTwo_CallBack : CallBack
    {
        ...
        public UserFormTwo_CallBack(BusinessQueue businessQueue_one, BusinessQueue businessQueue_two
            , BusinessQueue businessQueue_three,BusinessQueue businessQueue_four)
        {
